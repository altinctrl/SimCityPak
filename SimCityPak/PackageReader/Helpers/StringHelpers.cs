namespace Gibbed.Spore.Helpers
{
	public static class StringHelpers
	{
		...
		public static uint FNV(this string input, bool caseSesitive = false)
		{
            if (caseSesitive == false)
            {
                input = input.ToLowerInvariant(); // (trgs) confirmed that everything is converted to lowercase
            }
