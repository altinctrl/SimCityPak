...
namespace Gibbed.Spore.Package
{
    ...
    public class DatabasePackedFile
    {
        ...
        /// <summary>
        /// Opens the file and returns the data as a byte array
        /// </summary>
        ...
        public DatabaseIndex InsertIndex(byte[] data, uint typeId = 0, uint GroupContainer = 0, uint instanceId = 0)
        {
